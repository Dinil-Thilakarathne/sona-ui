...
const previewValues: Record<string, [light: string, dark: string]> = {
  ...
  danger: ["oklch(0.97 0.01 25)", "oklch(0.34 0.1 20)"],
  "danger-foreground": ["oklch(0.53 0.18 25)", "oklch(0.75 0.15 25)"],
  "danger-border": ["oklch(0.9 0.05 25)", "oklch(0.36 0.11 25)"],
  ...
  info: ["oklch(0.97 0.01 250)", "oklch(0.26 0.07 250)"],
  "info-foreground": ["oklch(0.45 0.12 250)", "oklch(0.72 0.15 250)"],
  "info-border": ["oklch(0.9 0.05 250)", "oklch(0.36 0.1 250)"],
  success: ["oklch(0.97 0.04 145)", "oklch(0.26 0.07 145)"],
  "success-foreground": ["oklch(0.48 0.15 145)", "oklch(0.72 0.15 145)"],
  "success-border": ["oklch(0.9 0.1 145)", "oklch(0.36 0.11 145)"],
};
