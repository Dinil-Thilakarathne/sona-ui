...
const tagVariants = type(
  '"new" | "soon" | "updated" | "beta" | "featured" | "default"',
);
const typeVariants = type(
  '"Components" | "Text" | "Effects" | "Getting Started" | "Primitives" | "Actions & Inputs" | "Navigation & Disclosure" | "Motion" | "Shaders"',
);
