...
<Tabs
  tabs={[
    {
      title: "Preview",
      content: <ComponentPreview componentPath="Accordion_ex.tsx" />,
    },
    {
      title: "Usage",
      content: (
...
`}/> ), }, 
{
  title: "Data",
  content: (
    <CodeSyntaxHighlighter language="tsx" code={
      `
...
{
  title: "CLI",
  content: <CodeSyntaxHighlighter language="js" code={`npx @sonacode/sonaui-cli download Accordion`}/>
}
]} />
