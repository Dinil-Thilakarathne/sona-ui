...
import smart_overflow_smart_overflow_demo from "@/registry/examples/smart-overflow/smart-overflow-demo";
      ...
      {view === "compact" ? (
        <div className="p-2">
          <button
            ...
            className="flex items-center gap-3 rounded-xl px-3 py-2 text-sm outline-none transition-colors bg-secondary hover:bg-muted hover:cursor-pointer focus-visible:ring-2 focus-visible:ring-ring"
          >
        ...
        <div className="w-80 p-4 bg-secondary">
...
export default function AnimatedDialogToast() {
  ...
  "smart-overflow": [
    {
      name: "default",
      component: smart_overflow_smart_overflow_demo,
      code: `"use client";
...
import SmartOverflow, {
  SmartOverflowAction,
} from "@/components/ui/smart-overflow/smart-overflow";
...
`,
      path: "smart-overflow/smart-overflow.tsx",
      target: "components/sonaui/smart-overflow/smart-overflow.tsx"
    }
  ],
  "split-text": [
    {
